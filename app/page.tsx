...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-background noise-overlay items-center">
      ...
      {/* MAIN FIX HERE 👇 */}
      <main className="flex-1 w-full flex flex-col items-center py-12 md:py-20">
        
        <div className="w-full max-w-5xl space-y-16 flex flex-col items-center">
              ...
              {features.map((feature) => {
                ...
                return (
                  <div key={feature.label} className="group relative">
                    <div
                      className={`absolute -inset-0.5 bg-gradient-to-r ${feature.gradient} rounded-xl opacity-0 group-hover:opacity-50 blur transition`}
                    />
                    <div className="relative flex items-center gap-2.5 px-4 py-2.5 bg-card/80 backdrop-blur-sm rounded-xl border border-border/50 hover:border-primary/50">
                      
                      <div
                        className={`flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br ${feature.gradient}`}
                      >
          ...
          {/* ANALYZER */}
          <div className="relative animate-scale-in w-full flex justify-center">
